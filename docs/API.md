...
Inventory Admin routes: `GET /api/v1/admin/inventory`, `/summary`, `/:skuId`, and `/:skuId/movements` require `inventory.view`; signed adjustment, correction, and reorder-level changes require `inventory.manage`.
