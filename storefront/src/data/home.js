...
export const skinTypes = [
  { name: 'Normal', description: 'Maintain everyday balance', image: homeImages.hero },
  { name: 'Dry', description: 'Replenish comfort & moisture', image: homeImages.dryness },
  { name: 'Oily', description: 'Balance without over-drying', image: homeImages.gel },
  { name: 'Combination', description: 'Care for changing zones', image: homeImages.barrier },
  { name: 'Sensitive', description: 'Gentle comfort comes first', image: homeImages.spots },
  { name: 'Acne-Prone', description: 'Clarify with thoughtful care', image: homeImages.acne },
]

export const ingredients = [
  { name: 'Vitamin C', description: 'For brighter-looking, more radiant skin' },
  { name: 'Niacinamide', description: 'Supports balance and smoother-looking texture' },
  ...
  { name: 'Salicylic Acid', description: 'Helps clarify congested-looking skin' },
  { name: 'Retinol', description: 'Supports smoother, renewed-looking skin' },
]

export const brandPrinciples = [
  { title: 'Purposeful formulas', text: 'Every product starts with a clear role in your routine.' },
  { title: 'Routine-first design', text: 'Products made to work naturally within everyday skincare.' },
  { title: 'Considered experience', text: 'Texture, usability and presentation matter as much as the formula story.' },
]
