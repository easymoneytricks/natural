    ...
    <Guard>
      <Layout active="Rewards">
        ...
        {account === null ? (
          ...
          <p className="account-muted">Rewards are temporarily unavailable.</p>
        ) : (
          <>
            <p className="account-muted">
              Available points: {account.available}
            </p>
            <p className="account-muted">
  ...
  return (
    <Guard>
      <Layout active="Gift Cards">
        ...
        <p className="account-muted">
          Gift cards purchased for your account will appear here.
        </p>
        <p>
          No gift cards available yet. <Link to="/shop">Explore skincare</Link>
        </p>
      </Layout>
    </Guard>
  );
