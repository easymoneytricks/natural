...
const codes = new Set(
  "INVALID_QUERY PRODUCT_NOT_FOUND CATEGORY_NOT_FOUND BRAND_NOT_FOUND VALIDATION_ERROR INVALID_REVIEW PURCHASE_REQUIRED REVIEW_ALREADY_EXISTS REVIEW_NOT_FOUND INVALID_REVIEW_STATUS EMAIL_ALREADY_EXISTS PHONE_ALREADY_EXISTS EMAIL_NOT_VERIFIED INVALID_EMAIL_OTP EMAIL_OTP_ATTEMPTS_EXCEEDED RECAPTCHA_REQUIRED RECAPTCHA_FAILED RECAPTCHA_UNAVAILABLE RECAPTCHA_NOT_CONFIGURED STORE_NOT_ACCEPTING_ORDERS INVALID_CREDENTIALS UNAUTHENTICATED SESSION_EXPIRED RATE_LIMITED ADDRESS_NOT_FOUND SKU_NOT_FOUND SKU_UNAVAILABLE INSUFFICIENT_STOCK COUPON_NOT_FOUND COUPON_EXPIRED COUPON_MINIMUM_NOT_MET COUPON_USAGE_LIMIT_REACHED GIFT_CARD_NOT_FOUND GIFT_CARD_DISABLED GIFT_CARD_EMPTY GIFT_CARD_EXPIRED SHIPPING_METHOD_UNAVAILABLE CART_INVALID ONLINE_PAYMENT_NOT_AVAILABLE_YET IDEMPOTENCY_KEY_CONFLICT ORDER_NOT_FOUND COD_UNAVAILABLE GIFT_CARD_INVALID RAZORPAY_UNAVAILABLE RAZORPAY_NOT_CONFIGURED PAYMENT_VERIFICATION_FAILED FORBIDDEN ACCOUNT_DISABLED SLUG_ALREADY_EXISTS INVALID_PRICE INVALID_MRP SKU_CODE_EXISTS SKU_COMBINATION_EXISTS ATTRIBUTE_NOT_ASSIGNED ATTRIBUTE_VALUE_NOT_ALLOWED INCOMPLETE_SKU_ATTRIBUTES NOT_FOUND INVALID_FILE FILE_TOO_LARGE".split(
    " ",
  ),
);
